...
- (void)setFrame:(CGRect)frame {
    CGRect frameWithConstantHeight = frame;
    frameWithConstantHeight.size.height = 32.f;
    [super setFrame:frameWithConstantHeight];
}

- (CGRect)frame {
    CGRect frameWithConstantHeight = [super frame];
    frameWithConstantHeight.size.height = 32.f;
    return frameWithConstantHeight;
}
