...
@interface ButtonMultiplyDownPicker()<DropDownHeaderViewDelegate>
...
@implementation ButtonMultiplyDownPicker
...
- (void)doneButtonTapped:(DropDownHeaderView *)dropDownHeaderView {
    ...
    [(id<ButtonMultiplyDownPickerDelegate>)self.delegate buttonMultiplyDownPicker:self didSelectedRowsAtIndexPathes:self.selectedIndexPathes];
    [self hideDownPicker];
}
